# %%
# Based on:
# https://github.com/ArthurConmy/Automatic-Circuit-Discovery/blob/main/acdc/docstring/prompts.py  # noqa: E501
"""
...
class BatchedPrompts:
    ...
    def correct_prob(self, logits, pos: int = -1):
    ...
    def correct_rank(self, logits, pos: int = -1):
        pos_logits = logits[:, pos, :]
...
def docstring_induction_prompt_generator(
    ...
    *,
    ...
    random_random_mid_doc_args, args_ = (
        args_[:n_not_matching_args],
        args_[n_not_matching_args:],
    )
...
prompt = docstring_induction_prompt_generator(
    "rest",
    n_matching_args=3,
    n_def_prefix_args=2,
    n_def_suffix_args=1,
