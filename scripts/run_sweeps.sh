...
pdm run python circuit_finder/paper/run_leap_experiment_batched.py --save_dir_prefix corrupt_keep_error --contrast_pairs True --ablate_act_type tokenwise
pdm run python circuit_finder/paper/run_leap_experiment_batched.py --save_dir_prefix corrupt_ablate_error --contrast_pairs True --ablate_act_type tokenwise --error_ablate_type value
