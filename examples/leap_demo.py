...
num_nodes_list = []
metrics_list = []
for threshold in tqdm([0.001, 0.002, 0.003, 0.004, 0.005, 0.007, 0.01, 0.03, 0.06, 0.1]):
    model.reset_hooks()
...
fig = px.line(x=num_nodes_list, y=faith,  
